...
#
# 참고치(유형별, **단위가 달라 직접 비교는 안 된다**):
#   · 국내 신축 공동주택 실측 평균 약 2.40 m³/(h·㎡) @50 Pa, 유동지수 평균 0.61
#   · 국내 기존 학교 교실 15~23 ACH50  ← 체적 기준이라 위와 환산 없이는 못 비교한다
# 건물 유형·노후도 편차가 매우 커서 5 는 **기존 건물용 보수적 기본값**으로만 쓴다 —
