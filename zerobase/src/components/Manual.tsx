...
import { BookOpen, AlertCircle, Building2, Layout, Sliders, BarChart3, ChevronRight } from 'lucide-react';
    ...
    <section id="가이드" className="py-24 px-6 bg-white relative overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center p-12 bg-gradient-to-br from-brand-primary/5 to-brand-secondary/5 rounded-[3rem] border border-slate-100 shadow-sm">
          ...
          <button className="px-10 py-5 bg-slate-900 text-white rounded-full font-black text-lg hover:bg-brand-primary transition-all shadow-lg shadow-slate-200">
            시뮬레이션 시작하기
          </button>
        </div>
      </div>
